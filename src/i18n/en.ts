export const en = {
  ...
  propertyDetail: {
    ...
    type: 'Type',
    talkToUs: 'Talk to us',
    whatsappContactText: 'Write to us on WhatsApp to answer questions or schedule a personalized visit.',
    quickResponse: 'Quick response',
    quickResponseText: 'We respond to messages and coordinate tours.',
